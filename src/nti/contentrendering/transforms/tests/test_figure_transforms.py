...
class TestTransforms(ContentrenderingLayerTest):
	...
	def test_exerciseRightPicTransform(self):
		example = br"""
		\exercises
	...
	def test_exerciseRightPicTransformFirstElement(self):
		example = br"""
		\exercises
	...
	def test_revprobLeftPicTransform(self):
		example = br"""
		\reviewprobs
	...
	def test_revProbParPicTransformNoMove(self):
		example = br"""
		\reviewprobs
	...
	def test_challProbParPicTransform(self):
		example = br"""
		\challengeprobs
	...
	def test_challLeftPicTransformFirstElementOwnPar(self):
		example = br"""
	\challengeprobs
	...
	def test_solutionParPicTransform(self):
		example = br"""
	...
	def test_partRightPicTransform(self):
		example = br"""
	\begin{parts}
	...
	def test_partLeftPicTransformMerged(self):
		example = br"""
	\begin{parts}
	\part
	...
	def test_partRightPicTransformNoMove(self):
		example = br"""
	\begin{parts}
	\part
	\rightpic{geometry_65.pdf}
	...
	def test_bodyLeftPicTransform(self):
		example = br"""
