...
class TestArchive(ConfiguringTestBase):
	...
	def test_archive_biology(self):
		...
		assert_that('intro-biology-rendered-book/eclipse-toc.xml', is_in(added))
		assert_that('intro-biology-rendered-book/icons/chapters/C2.png', is_in(added))
		assert_that('intro-biology-rendered-book/images/chapters/C2.png', is_in(added))
		assert_that('intro-biology-rendered-book/js/worksheet.js', is_in(added))
		assert_that('intro-biology-rendered-book/styles/prealgebra.css', is_in(added))
