...
@interface.implementer(cloudsearch_interfaces.ICloudSearchStore)
...
@interface.implementer(cloudsearch_interfaces.ICloudSearchStoreService)
class _CloudSearchStorageService(_RedisStorageService):
	...
	def store(self):
		if self._store is None:
			self._store = component.getUtility(cloudsearch_interfaces.ICloudSearchStore)
		return self._store
