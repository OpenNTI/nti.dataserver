...
from nti.contentsearch.generations.evolve25 import evolve
...
class TestEvolve25(mock_dataserver.ConfiguringTestBase):
	...
	def test_evolve25(self):
		with mock_db_trans() as conn:
			...
			catalog = rim.get(redaction_)
			catalog.pop(replacementContent_, None)
			catalog.pop(redactionExplanation_, None)
