...
class Session(AbstractSession):
    ...
    # originating_site_names = () # actually in the superclass for conflict
    # resolution
    ...
    def get_messages_to_client(self):
        """
        Returns an iterable of messages to the client, or possibly None if the session is dead. 
        These messages are now considered consumed and cannot be retrieved by this method again.
        """
        session_service = component.getUtility(IDataserver).session_manager
