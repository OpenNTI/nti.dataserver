...
class _OIDResolver(object):
    ...
    def resolve(self, key):
        ...
        try:
            ...
            # Unpacking an OID key can raise ValueError if its in the wrong
            # format
...
class _UGDResolver(_AbstractUserBasedResolver):
    ...
    def _resolve(self, key, user):
        ...
        if not IUser.providedBy(user):
            ...
            # This is because of the inconsistency in the way it is defined and
            # implemented.
            return None
