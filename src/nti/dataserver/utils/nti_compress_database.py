...
def main():
	...
	arg_parser.add_argument( 'config_file', help="A zodbconvert-style configuration" )
	arg_parser.add_argument( '-v', '--verbose', help="Be verbose", action='store_true', dest='verbose')
	arg_parser.add_argument( '--dry-run', help="Don't actually do anything", action='store_true', dest='dry_run')
	arg_parser.add_argument( '--limit', help="Only attempt to compress this many rows", dest='limit', type=int )
	arg_parser.add_argument( '--uncompress', help="Uncompress instead of compress", dest='uncompress', action='store_true' )
