...
def list_communities():
    ...
    for entity in users_folder.values():
        ...
        row = [entity.username, fn.realname, fn.alias,
               str(entity.public), str(entity.joinable),
               str(not IDisallowActivityLink.providedBy(entity))]
...
def main():
    arg_parser = argparse.ArgumentParser(description="Join one or more "
