...
try:
    ...
    def _store_asset(content_unit, unused_container, ntiid, item):
...
def do_evolve(context, generation=generation):
    ...
    with site(dataserver_folder):
        ...
        catalog = lsm.getUtility(IContainedObjectCatalog,
        ...
        job = functools.partial(_store_assets, intids, catalog, seen)
        run_job_in_all_host_sites(job)
