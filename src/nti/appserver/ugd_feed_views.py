...
def feed_view( request ):
	...
	for change in ext_dict['Items']:
		renderer = IFeedRenderer( change.object, None )
		...
		feed.add_item(
			...
			author_name=creator_profile.realname or creator_profile.alias or unicode(change.creator),
			...
			updated=dc_interfaces.IDCTimes( change ).modified,
			published=dc_interfaces.IDCTimes( change ).created,
			)
