...
class IUserRequestEvent(IUserEvent):
    ...
    request = schema.Object(IRequest,
                            title=u"The request that completed the login process.",
...
class IUserUpgradedEvent(IUserEvent):
    ...
    restricted_interface = schema.InterfaceField(title=u"The original interface.")
    restricted_profile = schema.Object(IUserProfile,
                                       title=u"The original profile.")

    upgraded_interface = schema.InterfaceField(title=u"The new interface.")
    upgraded_profile = schema.Object(IUserProfile,
                                     title=u"The new profile.")
...
class IExternalFieldResource(ILocation):
    ...
    wrap_value = schema.Bool(title=u"Whether to wrap the value as a dictionary name:value.",
                             description=u"If False, then assume that the value passed in is acceptable to the object to update.",
                             default=True,
                             required=False)
...
class IPageContainerResource(interface.Interface):
    ...
    user = schema.Object(IUser, title=u"The user that owns the page container")
