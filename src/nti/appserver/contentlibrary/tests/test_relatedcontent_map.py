...
class TestRelatedContentIndexMap(SharedConfiguringTestBase):
	...
	def setUp(self):
		...
		rc_map = rcm_module.RelatedContentIndexMap()
		component.provideUtility(rc_map, app_interfaces.IRelatedContentIndexMap)
