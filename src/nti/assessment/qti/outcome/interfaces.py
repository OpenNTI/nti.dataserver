...
class IoutcomeProcessing(IFiniteSequence, qti_interfaces.IConcrete):
	IoutcomeRule = qti_schema.List(schema.Object(IoutcomeRule), title="Order list of outcome rules", min_length=0)
...
class IoutcomeIf(qti_interfaces.IConcrete):
	...
	outcomeRule = qti_schema.List(schema.Object(IoutcomeRule), title='The ordered outcome rules', required=False, min_length=0)
...
class IoutcomeCondition(IoutcomeRule, qti_interfaces.IConcrete):
	...
	outcomeElseIf = qti_schema.List(schema.Object(IoutcomeElseIf), title='outcome if list', required=False, min_length=0)
