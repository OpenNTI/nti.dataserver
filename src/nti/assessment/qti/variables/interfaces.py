...
class IdefaultValue(attr_interfaces.IdefaultValueAttrGroup, IFiniteSequence, qti_interfaces.IConcrete):
	value = qti_schema.List(schema.Object(Ivalue), title="An ordered list of values", min_length=1)
...
class Imapping(attr_interfaces.ImappingAttrGroup, IFiniteSequence, qti_interfaces.IConcrete):
	mapEntry = qti_schema.List(schema.Object(ImapEntry), title="The map is defined by a set of mapEntries", min_length=1)
...
class IareaMapping(attr_interfaces.IareaMappingAttrGroup, IFiniteSequence, qti_interfaces.IConcrete):
	areaMapEntry = qti_schema.List(schema.Object(IareaMapEntry), title="An ordered list of entries", min_length=1)
...
class ImatchTable(IlookupTable, IFiniteSequence, qti_interfaces.IConcrete):
	matchTableEntry = qti_schema.List(schema.Object(ImatchTableEntry), title="An ordered list of entries", min_length=1)
...
class IinterpolationTable(IlookupTable, IFiniteSequence, qti_interfaces.IConcrete):
	interpolationTableEntry = qti_schema.List(schema.Object(IinterpolationTableEntry), title="An ordered list of entries", min_length=1)
