...
class Iprompt(basic_interfaces.IbodyElement, IFiniteSequence, qti_interfaces.IConcrete):
	values = qti_schema.List(schema.Object(cnt_interfaces.IinlineStatic) , title="Choice interactions")
...
class IgapText(IgapChoice, IFiniteSequence, qti_interfaces.IConcrete):
	texrOrVariable = qti_schema.List(schema.Object(basic_interfaces.ITextOrVariable), title="The variables", min_length=0)
...
class IsimpleAssociableChoice(IassociableChoice, attr_interfaces.IsimpleAssociableChoiceAttrGroup, IFiniteSequence, qti_interfaces.IConcrete):
	flowStatic = qti_schema.List(schema.Object(cnt_interfaces.IflowStatic), title="associableChoice is a choice that contains flowStatic objects", min_length=0)

class IsimpleChoice(Ichoice, attr_interfaces.IsimpleChoiceAttrGroup, qti_interfaces.IConcrete):
	flowStatic = qti_schema.List(schema.Object(cnt_interfaces.IflowStatic), title="simpleChoice is a choice that contains flowStatic objects")
...
class IassociateInteraction(IblockInteraction, attr_interfaces.IassociateInteractionAttrGroup, IFiniteSequence,
	...
	simpleAssociableChoice = qti_schema.List(schema.Object(IsimpleAssociableChoice), title="An ordered set of choices.", min_length=1)
...
class IchoiceInteraction(IblockInteraction, attr_interfaces.IchoiceInteractionAttrGroup, IFiniteSequence, qti_interfaces.IConcrete):
	simpleChoice = qti_schema.List(schema.Object(IsimpleChoice), title="An ordered list of the choices that are displayed to the user", min_length=1)
...
class IsimpleMatchSet(IFiniteSequence, qti_interfaces.IConcrete):
	simpleAssociableChoice = qti_schema.List(schema.Object(IsimpleAssociableChoice), title="An ordered set of choices for the set.", min_length=0)
...
class ImatchInteraction(IblockInteraction, attr_interfaces.ImatchInteractionAttrGroup, IFiniteSequence, qti_interfaces.IConcrete):
	simpleMatchSet = qti_schema.List(schema.Object(IsimpleMatchSet), title="The two sets of choices", min_length=2, max_length=2)
	
class IgapMatchInteraction(IblockInteraction, attr_interfaces.IgapMatchInteractionAttrGroup, qti_interfaces.IConcrete):
	gapChoice = qti_schema.List(schema.Object(IgapChoice), title="An ordered list of choices for filling the gaps", min_length=1)
	blockStatic = qti_schema.List(schema.Object(cnt_interfaces.IblockStatic), title="A piece of content that contains the gaps", min_length=1)
	
# text-based interactions

class IinlineChoice(Ichoice, IFiniteSequence, qti_interfaces.IConcrete):
	textOrVariable = qti_schema.List(schema.Object(basic_interfaces.ITextOrVariable), title="Order list varibles", min_length=0)
...
class IinlineChoiceInteraction(IinlineInteraction, attr_interfaces.IinlineChoiceInteractionAttrGroup, IFiniteSequence, qti_interfaces.IConcrete):
	inlineChoice = qti_schema.List(schema.Object(IinlineChoice), title="An ordered list of the choices that are displayed to the user", min_length=0)
...
class IhottextInteraction(IblockInteraction, attr_interfaces.IhottextInteractionAttrGroup, IFiniteSequence, qti_interfaces.IConcrete):
	blockStatic = qti_schema.List(schema.Object(cnt_interfaces.IblockStatic), title="The ordered content of the interaction is simply a piece of content", min_length=1)

class Ihottext(Ichoice, cnt_interfaces.IflowStatic, cnt_interfaces.IinlineStatic, IFiniteSequence, qti_interfaces.IConcrete):
	inlineStatic = qti_schema.List(schema.Object(cnt_interfaces.IinlineStatic), title="The order content", min_length=0)
...
class IhotspotInteraction(IgraphicInteraction, IFiniteSequence, attr_interfaces.IhotspotInteractiontAttrGroup, qti_interfaces.IConcrete):
	hotspotChoice = qti_schema.List(schema.Object(IhotspotChoice), title="The ordered choices", min_length=1)
...
class IgraphicAssociateInteraction(IgraphicInteraction, IFiniteSequence, attr_interfaces.IgraphicAssociateInteractiontAttrGroup, qti_interfaces.IConcrete):
	associableHotspot = qti_schema.List(schema.Object(IassociableHotspot), title="The ordered choices", min_length=1)

class IgraphicGapMatchInteraction(IgraphicInteraction, qti_interfaces.IConcrete):
	gapImg = qti_schema.List(schema.Object(IgapImg), title="An ordered list of choices for filling the gaps", min_length=1)
	associableHotspot = qti_schema.List(schema.Object(IassociableHotspot), title="The hotspots that define the gaps that are to be filled by the candidate", min_length=1)
...
class IpositionObjectStage(cnt_interfaces.Iblock, qti_interfaces.IConcrete):
	...
	positionObjectInteraction = qti_schema.List(schema.Object(IpositionObjectInteraction), title="The ordered positionObjectInteraction", min_length=1)
